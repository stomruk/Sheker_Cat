 ...
 */
final class Version20230102142440 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE games (id INT AUTO_INCREMENT NOT NULL, developper_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, cover VARCHAR(255) NOT NULL, price DOUBLE PRECISION NOT NULL, date VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_FF232B31DA42B93 (developper_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
